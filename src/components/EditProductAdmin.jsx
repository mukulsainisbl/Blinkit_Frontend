...
const EditProductAdmin = ({ close , data  : propsData  , fetchProductData }) => {
  ...
  return (
    <section className="fixed top-0 bottom-0 right-0 left-0 bg-neutral-300 z-50 p-4">
      <div className=" rounded bg-white max-w-2xl w-full mx-auto overflow-y-auto h-full max-h-[95vh] ">
        <section className="p-2 bg-gray-50">
          ...
          <form onSubmit={handleSubmit} className="p-3  grid gap-4" action="">
            ...
            <button className=" p-2 transition-all duration-700 bg-amber-400 hover:bg-green-700 font-semibold rounded border outline-none ">
              Update Product
            </button>
